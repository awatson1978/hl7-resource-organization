...
Organizations.prepForUpdate = function (organization) {
  ...
  // if (organization.name && organization.name[0]) {
  //   //console.log("organization.name", organization.name);

  //   organization.name.forEach(function(name){
  //     name.resourceType = "HumanName";
  //   });
  // }

  // if (organization.telecom && organization.telecom[0]) {
  //   //console.log("organization.telecom", organization.telecom);
  ...
  //   //console.log("organization.contact", organization.contact);
...
Organizations.prepForFhirTransfer = function (organization) {
  //console.log("Organizations.prepForBundle()");


  // // FHIR has complicated and unusual rules about dates in order
  // // to support situations where a family member might report on a organization's
  // // date of birth, but not know the year of birth; and the other way around
  // if (organization.birthDate) {
  //   organization.birthDate = moment(organization.birthDate).format("YYYY-MM-DD");
  // }
  ...
  //       //console.log("organization.contact.name", contact.name);
